...
<<<<<<< codex/evaluate-modifying-existing-android-project-eecnx3
        ...
        s1.text = getString(R.string.terms_section1_title)
        b1.text = getString(R.string.terms_section1_body)
        s2.text = getString(R.string.terms_section2_title)
        b2.text = getString(R.string.terms_section2_body)
        s3.text = getString(R.string.terms_section3_title)
        b3.text = getString(R.string.terms_section3_body)
