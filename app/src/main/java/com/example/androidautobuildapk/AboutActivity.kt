...
class AboutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tocContent).text = getString(R.string.about_toc)
        findViewById<TextView>(R.id.section1Title).text = getString(R.string.about_section1_title)
        findViewById<TextView>(R.id.section1Body).text = getString(R.string.about_section1_body)
        findViewById<TextView>(R.id.section2Title).text = getString(R.string.about_section2_title)
        findViewById<TextView>(R.id.section2Body).text = getString(R.string.about_section2_body)
        findViewById<TextView>(R.id.section3Title).text = getString(R.string.about_section3_title)
