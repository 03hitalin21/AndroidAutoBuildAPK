...
class AboutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b1.text = getString(R.string.about_section1_body)
        s2.text = getString(R.string.about_section2_title)
        b2.text = getString(R.string.about_section2_body)
        s3.text = getString(R.string.about_section3_title)
        b3.text = getString(R.string.about_section3_body)
        findViewById<TextView>(R.id.highlightNote).text = getString(R.string.about_note)

        val icon1 = if (1 == 1) R.drawable.ic_info_24 else R.drawable.ic_book_24
        val icon2 = R.drawable.ic_book_24
        val icon3 = R.drawable.ic_lightbulb_24
    ...
    private fun openDetail(title: String, body: String, iconRes: Int) {
        startActivity(Intent(this, SectionDetailActivity::class.java).apply { putExtra("title", title); putExtra("body", body); putExtra("icon", iconRes) })
    }
}
