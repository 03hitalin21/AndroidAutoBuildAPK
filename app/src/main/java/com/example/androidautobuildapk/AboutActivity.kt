...
class AboutActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        s1.text = getString(R.string.about_section1_title); b1.text = getString(R.string.about_section1_body)
        s2.text = getString(R.string.about_section2_title); b2.text = getString(R.string.about_section2_body)
        s3.text = getString(R.string.about_section3_title); b3.text = getString(R.string.about_section3_body)
        ...
        ArticleActions.bind(this, getString(R.string.menu_about))
    }
