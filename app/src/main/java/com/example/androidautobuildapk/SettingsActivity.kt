...
class SettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        s1.text = getString(R.string.settings_section1_title)
        b1.text = getString(R.string.settings_section1_body)
        s2.text = getString(R.string.settings_section2_title)
        b2.text = getString(R.string.settings_section2_body)
        s3.text = getString(R.string.settings_section3_title)
        b3.text = getString(R.string.settings_section3_body)
        findViewById<TextView>(R.id.highlightNote).text = getString(R.string.settings_note)
