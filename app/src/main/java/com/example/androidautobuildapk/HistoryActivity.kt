...
class HistoryActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        s1.text = getString(R.string.history_section1_title); b1.text = getString(R.string.history_section1_body)
        s2.text = getString(R.string.history_section2_title); b2.text = getString(R.string.history_section2_body)
        s3.text = getString(R.string.history_section3_title); b3.text = getString(R.string.history_section3_body)
        findViewById<TextView>(R.id.highlightNote).text = getString(R.string.history_note)
